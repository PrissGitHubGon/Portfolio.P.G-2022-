    ...
    <>
      <main className=" w-full md:w-full lg:w-full  ">
        <div className="bg-black   w-full flex flex-col md:flex-row  ">
          <aside className="w-full  md:w-1/3 lg:w-1/4 bg-[url('https://res.cloudinary.com/dl6flp50k/image/upload/v1658304658/294103591_2299089073562502_350884712205389612_n_m4y1rb.jpg')] bg-cover bg-center px-5 py-56  "></aside>{" "}
