...
function Welcome() {
  return (
    <div className="w-screen h-screen bg-[url('https://res.cloudinary.com/dl6flp50k/image/upload/v1658498216/fondHome_xqpssr.png')]  bg-cover bg-center flex justify-center items-center">
